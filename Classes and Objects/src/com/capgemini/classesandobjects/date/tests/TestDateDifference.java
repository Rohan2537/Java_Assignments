...
package com.capgemini.classesandobjects.date.tests;
	...
	public class TestDateDifference {
			...
			public void setUp() {
				...
				dateTwo = new Date(8, 3, 2010);
			
			}
			@Test
			public void testDaysDifference() {	//test for days difference;
				
				int[] differerenceInDate = dateOne.difference(dateTwo);
				assertEquals(3, differerenceInDate[0]);
			}

			@Test
			public void testMonthsDifference() {	//test for months difference;
				
				int[] differenceInDate = dateOne.difference(dateTwo);
				assertEquals(1, differenceInDate[1]);
			}
			
			@Test
			public void testYearsDifference() {		//test for years difference;
				
				int[] differenceInDate = dateOne.difference(dateTwo);
				assertEquals(10, differenceInDate[2]);
			}
		}
